...
float sonic_is_satellite(sonic *, const char *, int, int);
int sonic_is_gap(sonic *, const char *, int, int);
float sonic_is_segmental_duplication(sonic *, const char *, int, int);
...
float intersection_fraction(int, int, int, int);
#endif
